...
/**
 * <p>Classe Java de terceirosPagtosFisica2In complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="terceirosPagtosFisica2In">
 *   &lt;complexContent>
 ...
 *         &lt;element name="gridPensaoJudicial" type="{http://services.senior.com.br}terceirosPagtosFisica2InGridPensaoJudicial" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="gridPlanodeSaude" type="{http://services.senior.com.br}terceirosPagtosFisica2InGridPlanodeSaude" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="gridRateios" type="{http://services.senior.com.br}terceirosPagtosFisica2InGridRateios" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "terceirosPagtosFisica2In", propOrder = {
    "assIrf",
    "basIns",
    "basIrf",
    "cmpPte",
...
public class TerceirosPagtosFisica2In {
    ...
    protected List<TerceirosPagtosFisica2InGridPensaoJudicial> gridPensaoJudicial;
    @XmlElement(nillable = true)
    protected List<TerceirosPagtosFisica2InGridPlanodeSaude> gridPlanodeSaude;
    @XmlElement(nillable = true)
    protected List<TerceirosPagtosFisica2InGridRateios> gridRateios;
     ...
     * {@link TerceirosPagtosFisica2InGridPensaoJudicial }
     * 
     * 
     */
    public List<TerceirosPagtosFisica2InGridPensaoJudicial> getGridPensaoJudicial() {
        if (gridPensaoJudicial == null) {
            gridPensaoJudicial = new ArrayList<TerceirosPagtosFisica2InGridPensaoJudicial>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TerceirosPagtosFisica2InGridPlanodeSaude }
     * 
     * 
     */
    public List<TerceirosPagtosFisica2InGridPlanodeSaude> getGridPlanodeSaude() {
        if (gridPlanodeSaude == null) {
            gridPlanodeSaude = new ArrayList<TerceirosPagtosFisica2InGridPlanodeSaude>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TerceirosPagtosFisica2InGridRateios }
     * 
     * 
     */
    public List<TerceirosPagtosFisica2InGridRateios> getGridRateios() {
        if (gridRateios == null) {
            gridRateios = new ArrayList<TerceirosPagtosFisica2InGridRateios>();
        }
