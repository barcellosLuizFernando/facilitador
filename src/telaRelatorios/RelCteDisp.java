 ...
 */
public class RelCteDisp extends javax.swing.JInternalFrame {
     ...
     * @param conn
     */
    public RelCteDisp(ConexaoMySQL conn) {
        try {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Conhecimentos não vinculados");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        sql = "select * from bsctranscooper.conhecimentos a "
                + "left join bsctranscooper.rpa_detalhe b on (b.chave = a.chave and b.numero = a.numero) "
                + "where b.codigo is null and a.status_envio = 'AU' "
                + "AND a.emissao between '" + dateOut.format(dtInicial) + "' and '" + dateOut.format(dtFinal) + "' "
        ...
        rel.imprimir(sql, "ConhecimentosDisp.jasper", "Conhecimentos não vinculados", dtInicial, dtFinal);
