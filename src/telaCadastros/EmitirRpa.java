...
public class EmitirRpa extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jSpEmissao.setModel(new javax.swing.SpinnerDateModel(new java.util.Date(), new java.util.Date(), new java.util.Date(), java.util.Calendar.DAY_OF_MONTH));
        ...
        jSpPgto.setModel(new javax.swing.SpinnerDateModel(new java.util.Date(), null, new java.util.Date(), java.util.Calendar.DAY_OF_MONTH));
    ...
    private void jBtnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAdicionarActionPerformed
        ...
        if ("Incluir".equals(jBtnAdicionar.getText())) {
            ...
            if (cn.conecta()) {
                try {
                    cn.executeAtualizacao("TRUNCATE tmp_cte_rpa;");
            ...
            case 11:
                ...
                if (integ.buscaRpa(jTxtId.getText())) {
                    ...
                    if (cn.conecta()) {
                        try {
                            cn.executeAtualizacao("TRUNCATE tmp_cte_rpa;");
                            cn.executeAtualizacao("INSERT INTO tmp_cte_rpa (chave,numero,data,valor,peso,tarifa,pedagio) "
                                    + "SELECT chave,numero,data,valor,peso,tarifa,pedagio "
                                    + "FROM rpa_detalhe "
                    ...
                    try {
                        for (int x = jTblConsulta_Multi.getSelectedRowCount(); x != 0; x--) {
                            ...
                            try {
                                ...
                                sql = "INSERT INTO tmp_cte_rpa (chave,numero,data,valor,peso,tarifa,pedagio) "
                                        + "VALUES ('" + chaveCte + "','" + numeroCte + "','" + dataCte + "','" + valorCte + "','" + peso + "','" + tarifa + "','" + pedagio + "');";
